# Pascal API Integration Guide

## Quick Start

Get started with our API using Pascal and the Indy library.

### Installation

Install the appropriate HTTP client library for pascal.
...
Check our [community page](https://community.your-domain.com/sdks) for Pascal libraries maintained by the community.
