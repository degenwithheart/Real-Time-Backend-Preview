...
Get started with our API using Scala and the akka-http library.

### Installation

Install the appropriate HTTP client library for scala.
...
Check our [community page](https://community.your-domain.com/sdks) for Scala libraries maintained by the community.
