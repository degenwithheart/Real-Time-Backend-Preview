# Carbon API Integration Guide

## Quick Start

Get started with our API using Carbon and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for Carbon.
...
Check our [community page](https://community.your-domain.com/sdks) for Carbon libraries maintained by the community.
