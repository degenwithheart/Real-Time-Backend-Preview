# Solidity API Integration Guide

## Quick Start

Get started with our API using Solidity and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for solidity.
...
Check our [community page](https://community.your-domain.com/sdks) for Solidity libraries maintained by the community.
