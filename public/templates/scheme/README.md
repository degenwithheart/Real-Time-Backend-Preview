# Scheme API Integration Guide

## Quick Start

Get started with our API using Scheme and the http-client library.

### Installation

Install the appropriate HTTP client library for scheme.
...
Check our [community page](https://community.your-domain.com/sdks) for Scheme libraries maintained by the community.
