# Lua API Integration Guide

## Quick Start

Get started with our API using Lua and the socket.http library.

### Installation

Install the appropriate HTTP client library for lua.
...
Check our [community page](https://community.your-domain.com/sdks) for Lua libraries maintained by the community.
