...
Get started with our API using Swift and the URLSession library.

### Installation

No installation required - uses Foundation framework.
...
Check our [community page](https://community.your-domain.com/sdks) for Swift libraries maintained by the community.
