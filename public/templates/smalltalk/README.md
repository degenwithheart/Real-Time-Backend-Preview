...
Get started with our API using Smalltalk and the WebClient library.

### Installation

Install the appropriate HTTP client library for smalltalk.
...
Check our [community page](https://community.your-domain.com/sdks) for Smalltalk libraries maintained by the community.
