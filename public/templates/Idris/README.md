# Idris API Integration Guide

## Quick Start

Get started with our API using Idris and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for Idris.
...
Check our [community page](https://community.your-domain.com/sdks) for Idris libraries maintained by the community.
