# Purescript API Integration Guide

## Quick Start

Get started with our API using Purescript and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for purescript.
...
Check our [community page](https://community.your-domain.com/sdks) for Purescript libraries maintained by the community.
