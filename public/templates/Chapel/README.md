# Chapel API Integration Guide

## Quick Start

Get started with our API using Chapel and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for Chapel.
...
Check our [community page](https://community.your-domain.com/sdks) for Chapel libraries maintained by the community.
