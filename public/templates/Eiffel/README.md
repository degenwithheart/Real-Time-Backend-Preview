# Eiffel API Integration Guide

## Quick Start

Get started with our API using Eiffel and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for Eiffel.
...
Check our [community page](https://community.your-domain.com/sdks) for Eiffel libraries maintained by the community.
