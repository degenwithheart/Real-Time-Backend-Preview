# Ada API Integration Guide

## Quick Start

Get started with our API using Ada and the AWS library.

### Installation

Install the appropriate HTTP client library for ada.
...
Check our [community page](https://community.your-domain.com/sdks) for Ada libraries maintained by the community.
