# Groovy API Integration Guide

## Quick Start

Get started with our API using Groovy and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for groovy.
...
Check our [community page](https://community.your-domain.com/sdks) for Groovy libraries maintained by the community.
