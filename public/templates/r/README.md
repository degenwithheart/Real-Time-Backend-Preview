...
Get started with our API using R and the httr library.

### Installation

Install the appropriate HTTP client library for r.
...
Check our [community page](https://community.your-domain.com/sdks) for R libraries maintained by the community.
