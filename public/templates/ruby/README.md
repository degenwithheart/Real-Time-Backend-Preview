# Ruby API Integration Guide

## Quick Start

Get started with our API using Ruby and the Net::HTTP library.
...
Check our [community page](https://community.your-domain.com/sdks) for Ruby libraries maintained by the community.
