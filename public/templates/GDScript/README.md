# GDScript API Integration Guide

## Quick Start

Get started with our API using GDScript and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for GDScript.
...
Check our [community page](https://community.your-domain.com/sdks) for GDScript libraries maintained by the community.
