# Cobol API Integration Guide

## Quick Start

Get started with our API using Cobol and the web services library.

### Installation

Install the appropriate HTTP client library for cobol.
...
Check our [community page](https://community.your-domain.com/sdks) for Cobol libraries maintained by the community.
