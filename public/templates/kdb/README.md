# Kdb API Integration Guide

## Quick Start

Get started with our API using Kdb and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for kdb.
...
Check our [community page](https://community.your-domain.com/sdks) for Kdb libraries maintained by the community.
