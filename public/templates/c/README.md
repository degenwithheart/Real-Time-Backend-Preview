...
Get started with our API using C and the libcurl library.

### Installation

Install the appropriate HTTP client library for c.
...
Check our [community page](https://community.your-domain.com/sdks) for C libraries maintained by the community.
