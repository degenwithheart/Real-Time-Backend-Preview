# Rescript API Integration Guide

## Quick Start

Get started with our API using Rescript and the HTTP client library library.

### Installation

Install the appropriate HTTP client library for rescript.
...
Check our [community page](https://community.your-domain.com/sdks) for Rescript libraries maintained by the community.
